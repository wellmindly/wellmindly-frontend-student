  ...
  return (
    <section className="px-6 pt-10 pb-16 sm:pt-16 sm:pb-24 mx-auto max-w-6xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:items-center lg:gap-16 gap-12">
        ...
        <div className="relative flex justify-center items-center w-full min-h-[380px] sm:min-h-[440px]">
          ...
          {/* Floating Preview Card 1: Today's Tone */}
          <button
            type="button"
          ...
          {/* Floating Preview Card 2: Next Session with Coach */}
          <button
            type="button"
            onClick={handleBook}
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center justify-between gap-1 mb-0.5">
                <span className="text-2xs text-ink-500 font-bold uppercase tracking-wider truncate">Next Session</span>
                <Badge tone="coral" size="sm">Preview</Badge>
              </div>
              <div className="text-xs font-bold text-ink-900 hover:text-coral-700 transition-colors truncate">
